...
resource "aws_identitystore_group" "platform_unified_accounts_production_admin" {
  ...
  description       = "Grants members administrator access to the Unified Accounts Production account."
  identity_store_id = local.sso_identity_store_id
}
...
resource "aws_identitystore_group" "platform_unified_accounts_production_vpc_clientvpn" {
  ...
  description       = "Grants members access to the Unified Accounts Production Client VPN."
  identity_store_id = local.sso_identity_store_id
}
...
resource "aws_identitystore_group" "platform_unified_accounts_production_read_only_billing" {
  ...
  description       = "Grants members read-only Billing and Cost Explorer access to the Unified Accounts Production account."
  identity_store_id = local.sso_identity_store_id
}
...
resource "aws_identitystore_group" "platform_unified_accounts_production_read_only" {
  ...
  description       = "Grants members read-only access to the Unified Accounts Production account."
  identity_store_id = local.sso_identity_store_id
}